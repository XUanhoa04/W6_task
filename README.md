...
```bash
# 1. Fork / clone
git clone <your-fork-url> g4-costctl && cd g4-costctl
...
- [x] Fork → rename to `g4-costctl` → clone locally
...
- [x] Replace `g4` placeholders throughout README with your real group number
...
- [x] Post link in Slack `#w6-sidechallenge` thread:
      `G4 — https://github.com/XUanhoa04/W6_task — implemented: list, cost, terminate, tag, clean (25/25 tests passing)`
